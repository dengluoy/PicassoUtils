...
public final class Request {
    ...
    public PicassoNetworkListener networkListener;
    ...
    private Request(Uri uri, int resourceId, String stableKey, List<Transformation> transformations,
                    ...
                    boolean hasRotationPivot, boolean purgeable, Bitmap.Config config, Priority priority, PicassoNetworkListener networkListener) {
        this.uri = uri;
    ...
    public static final class Builder {
        ...
        public Request build() {
            ...
            return new Request(uri, resourceId, stableKey, transformations, targetWidth, targetHeight,
                    ...
                    hasRotationPivot, purgeable, config, priority, networkListener);
        }
    }
}
