...
public class Picasso {
    ...
    boolean shutdown;
    volatile PicassoNetworkListener networkListener;

    Picasso(Context context, Dispatcher dispatcher, Cache cache, Listener listener,
            RequestTransformer requestTransformer, List<RequestHandler> extraRequestHandlers, Stats stats,
            Bitmap.Config defaultBitmapConfig, boolean indicatorsEnabled, boolean loggingEnabled, PicassoNetworkListener networkListener) {
    ...
    public RequestCreator load(Uri uri) {
        return new RequestCreator(this, uri, 0, networkListener);
    }
    ...
    public RequestCreator load(String path) {
        if (path == null) {
            return new RequestCreator(this, null, 0, networkListener);
        }
    ...
    public RequestCreator load(int resourceId) {
        ...
        return new RequestCreator(this, null, resourceId, networkListener);
    }
    ...
    public Picasso networkListener(PicassoNetworkListener networkListener) {
        this.networkListener = networkListener;
        return this;
    }
    ...
    public static class Builder {
        ...
        private PicassoNetworkListener networkListener;
        ...
        public Builder networkListener(PicassoNetworkListener networkListener) {
            this.networkListener = networkListener;
            return this;
        }
        ...
        public Picasso build() {
            ...
            return new Picasso(context, dispatcher, cache, listener, transformer, requestHandlers, stats,
                    defaultBitmapConfig, indicatorsEnabled, loggingEnabled, networkListener);
        }
    }
